...
import pandas as pd
from allExpressions_NL_Loc1 import getFuncs as funcs_Loc1
from allExpressions_NL_Loc2 import getFuncs as funcs_Loc2
...
# plt.matshow(pearson_matrix / 2.0,  vmin=0, vmax=1)
# plt.colorbar()
# plt.title('Between-Subject N-L R^2 Scores')
# plt.savefig('./BetweenSubImages/H-O-NL.png')
###############################################################################################
...
# plt.matshow(pearson_matrix / 2.0,  vmin=0, vmax=1)
# plt.colorbar()
# plt.title('Between-Subject Linear R^2 Scores')
# plt.savefig('./BetweenSubImages/H-O-L.png')
###############################################################################################
...
#
# # plt.matshow((pearson_matrix_1 + pearson_matrix_2) / 2.0,  vmin=0, vmax=1)
# # plt.colorbar()
# # plt.title('Between-Subject N-L (Best) R^2 Scores')
# # plt.savefig('./BetweenSubImages/H-O-NL-Best.png')
#
...
#     y = scaler.fit_transform(predictors['Loc2']['all'].reshape(-1,1))
...
#     all_predictions = np.array(all_predictions)
#     avg_prediction = np.average(all_predictions, axis=0)
#     y = scaler.fit_transform(predictors['Loc1']['all'].reshape(-1,1))
#     gen_ls.append(scipy.stats.pearsonr(avg_prediction,y[:, 0].T)[0])
#     # plt.plot(y)
#     # plt.plot(avg_prediction)
